...
CouchbaseClient.prototype = new events.EventEmitter();
...
CouchbaseClient.prototype.OnStreamConnectionClosed = function(p_Timeout)
{
    ...
    if (this.ReconnectionAttempts >= (this.Hosts.length > 5 ? this.Hosts.length : 5))
        throw new Error('Failed to connect to couchbase after ' + (this.Hosts.length > 5 ? this.Hosts.length : 5) + ' attempts.');
...
CouchbaseClient.prototype.InitConnection = function()
{
    ...
    //console.log('http://' + this.Bucket + ':' + this.Password + '@' + this.CurrentHost + '/pools/default/bucketsStreaming/' + this.Bucket);
